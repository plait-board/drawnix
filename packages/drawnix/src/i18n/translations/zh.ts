...
const zhTranslations: Translations = {
  ...
  'menu.github': 'GitHub',
  'menu.webdavConfig': 'WebDAV 设置',
  'menu.webdavOpen': '从 WebDAV 打开',
  'menu.webdavSave': '保存到 WebDAV',
  'webdav.config.title': 'WebDAV 设置',
  'webdav.config.url': '服务器 URL',
  'webdav.config.username': '用户名',
  'webdav.config.password': '密码',
  'webdav.config.path': '路径 (可选)',
  'webdav.config.testConnection': '测试连接',
  'webdav.config.save': '保存',
  'webdav.config.cancel': '取消',
  'webdav.config.testSuccess': '连接成功',
  'webdav.config.testFail': '连接失败',
  'webdav.fileBrowser.title': 'WebDAV 文件浏览器',
  'webdav.fileBrowser.open': '打开',
  'webdav.fileBrowser.saveAs': '另存为',
  'webdav configuring': 'WebDAV 配置',
  'webdav username': '用户名',
  'webdav username placeholder': '输入用户名',
  'webdav password': '密码',
  'webdav password placeholder': '输入密码',
  'webdav path': '路径',
  'testing': '测试中...',
  'test connection': '测试连接',
  'webdav files': 'WebDAV 文件',
  'refresh': '刷新',
  'loading': '加载中...',
  'no drawnix files': '没有找到 drawnix 文件',
  'webdav not configured': 'WebDAV 未配置',
  'failed to load files': '加载文件失败',
  'failed to open file': '打开文件失败',
  'confirm delete file': '确定要删除此文件吗？',
