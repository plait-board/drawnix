...
const enTranslations: Translations = {
  ...
  'menu.github': 'GitHub',
  'menu.webdavConfig': 'WebDAV Settings',
  'menu.webdavOpen': 'Open from WebDAV',
  'menu.webdavSave': 'Save to WebDAV',
  'webdav.config.title': 'WebDAV Settings',
  'webdav.config.url': 'Server URL',
  'webdav.config.username': 'Username',
  'webdav.config.password': 'Password',
  'webdav.config.path': 'Path (optional)',
  'webdav.config.testConnection': 'Test Connection',
  'webdav.config.save': 'Save',
  'webdav.config.cancel': 'Cancel',
  'webdav.config.testSuccess': 'Connection successful',
  'webdav.config.testFail': 'Connection failed',
  'webdav.fileBrowser.title': 'WebDAV File Browser',
  'webdav.fileBrowser.open': 'Open',
  'webdav.fileBrowser.saveAs': 'Save As',
  'webdav configuring': 'WebDAV Settings',
  'webdav username': 'Username',
  'webdav username placeholder': 'Enter username',
  'webdav password': 'Password',
  'webdav password placeholder': 'Enter password',
  'webdav path': 'Path',
  'testing': 'Testing...',
  'test connection': 'Test Connection',
  'webdav files': 'WebDAV Files',
  'refresh': 'Refresh',
  'loading': 'Loading...',
  'no drawnix files': 'No drawnix files found',
  'webdav not configured': 'WebDAV not configured',
  ...
  'saved successfully': 'File saved successfully',
