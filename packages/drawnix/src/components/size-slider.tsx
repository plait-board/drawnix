...
export const SizeSlider: React.FC<SliderProps> = ({
  ...
  const handleSliderChange = useCallback(
    ...
    [min, max, step, onChange, setValue]
  );

  const throttledHandleSliderChange = useMemo(
  ...
  }, [throttledHandleSliderChange, afterEnd]);
    ...
    <div className={classNames('slider-container', { disabled: disabled })}>
      <div
        ...
        onClick={(event) => {
          ...
          throttledHandleSliderChange(event);
        }}
        onPointerDown={(event) => {
